...
import { ArrowLeft, Save, Send, Plus, Trash2, CreditCard, Loader2 } from 'lucide-react';
...
export const InvoiceDetail = () => {
  ...
  const handleSave = async () => {
    setLoading(true);
    try {
      const payload = { ...invoice, items, subtotal, vat_amount: vatAmount, total };
      if (isNew) {
        ...
        <div className="flex flex-wrap items-center gap-2">
          {!isNew && (
            <>
              ...
              <DownloadButton id={id!} type="invoice" mode="download" variant="outline" label="Download" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white border border-slate-200 rounded-xl p-6 space-y-4">
            ...
            <div className="space-y-2">
              <Label className="text-slate-600 text-sm">Notes / Payment Terms</Label>
              <Textarea
                value={invoice.notes || ''}
