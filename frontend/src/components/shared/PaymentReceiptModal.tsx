          ...
          {invoice && (
            <div className="bg-brand-bg/50 p-3 rounded-md border border-brand-border space-y-1.5 text-sm">
              <div className="flex justify-between">
                <span className="text-brand-subtle">Invoice</span>
                <span className="font-mono font-medium text-brand-accent">{invoice.invoice_number}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-brand-subtle">Customer</span>
                <span className="text-brand-primary">{invoice.customer?.name}</span>
              </div>
              <div className="flex justify-between pt-1.5 border-t border-brand-border">
                <span className="text-brand-subtle">Balance</span>
                <span className="font-mono font-medium text-danger"><CurrencyAmount amount={invoice.balance} currency={currency} /></span>
              </div>
            </div>
          )}
