...
<body>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="text-align: right; vertical-align: bottom;">
                    <span style="color: #666;">Invoice Date :</span> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo e(date('d M Y', strtotime($invoice->date))); ?>
    ...
    <table class="item-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: right; font-weight: bold; border-bottom: 0;"><?php echo e(number_format($invoice->subtotal, 2)); ?></td>
            </tr>
            <tr class="total-row">
                <td colspan="2" style="border: 0; background: white;">Items in Total <?php echo e(count($invoice->items)); ?>.00</td>
                <td colspan="2" style="border: 0; background: white;"></td>
                <td style="text-align: right; padding: 10px 8px;">Total</td>
                <td style="text-align: right; padding: 10px 8px;">AED<?php echo e(number_format($invoice->total, 2)); ?></td>
            </tr>
        </tbody>
    </table>

    <div class="words-total">
        Total In Words: &nbsp;&nbsp; <strong>UAE Dirham <?php echo e(\App\Helpers\NumberHelper::toWords($invoice->total)); ?></strong>
    </div>
        ...
        <table class="tax-table" style="width: 100%;">
            ...
            <tbody>
                <tr>
                    ...
                    <td><?php echo e(number_format($invoice->vat_amount, 2)); ?></td>
                </tr>
                <tr style="font-weight: bold; border-top: 1px solid #eee;">
                    <td>Total</td>
                    <td>AED<?php echo e(number_format($invoice->subtotal, 2)); ?></td>
                    <td>AED<?php echo e(number_format($invoice->vat_amount, 2)); ?></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="bank-details">
        ...
        <div style="font-size: 9px; margin-bottom: 15px;">Thank you for your business.</div>
...
<?php /**PATH /home/runner/work/zeronix-portal/zeronix-portal/backend/resources/views/pdf/invoice.blade.php ENDPATH**/ ?>