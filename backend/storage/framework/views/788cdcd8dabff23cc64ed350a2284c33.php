...
<body>
    <div class="container">
        ...
        <p>Hello <?php echo e($customer->name); ?>,</p>
        ...
        <div class="credentials">
            <p><strong>Login URL:</strong> <a href="<?php echo e(config('app.frontend_url')); ?>/portal/login"><?php echo e(config('app.frontend_url')); ?>/portal/login</a></p>
        ...
        <div style="text-align: center; margin-top: 30px;">
            <a href="<?php echo e(config('app.frontend_url')); ?>/portal/login" class="btn">Login to Portal</a>
        </div>

        <p>If you have any questions, feel free to reply to this email.</p>

        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> Zeronix Financial Portal. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /home/runner/work/zeronix-portal/zeronix-portal/backend/resources/views/emails/welcome_customer.blade.php ENDPATH**/ ?>