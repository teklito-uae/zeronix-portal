        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="vertical-align: top; text-align: right;">
                    ...
                    <div class="doc-number"># <?php echo e($quote->quote_number); ?></div>
                </td>
            </tr>
        </table>
    </div>
        ...
        <table style="width: 100%;">
            <tr>
                <td style="width: 60%;">
                    ...
                    <div class="customer-name"><?php echo e(strtoupper($quote->customer->company)); ?></div>
                    <div style="margin-top: 2px; color: #444;"><?php echo e($quote->customer->name); ?></div>
                    <div><?php echo e($quote->customer->address); ?></div>
                </td>
                <td style="text-align: right; vertical-align: bottom;">
                    <span style="color: #666;">Quote Date :</span> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo e(date('d M Y', strtotime($quote->date))); ?>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span style="color: #666; font-size: 8px;"><?php echo e($item->description); ?></span>
                </td>
                <td style="text-align: center;"><?php echo e(number_format($item->quantity, 2)); ?></td>
                <td style="text-align: right;"><?php echo e(number_format($item->unit_price, 2)); ?></td>
                <td style="text-align: right;"><?php echo e(number_format($item->total * 0.05, 2)); ?><br><span style="font-size: 7px; color: #999;">5.00%</span></td>
            ...
            <tr>
                ...
                <td style="text-align: right; font-weight: bold; border-bottom: 0;"><?php echo e(number_format($quote->subtotal, 2)); ?></td>
            </tr>
            <tr class="total-row">
                <td colspan="2" style="border: 0; background: white;">Items in Total <?php echo e(count($quote->items)); ?>.00</td>
                <td colspan="2" style="border: 0; background: white;"></td>
                <td style="text-align: right; padding: 10px 8px;">Total</td>
                <td style="text-align: right; padding: 10px 8px;">AED<?php echo e(number_format($quote->total, 2)); ?></td>
            </tr>
        </tbody>
    </table>

    <div class="words-total">
        Total In Words: &nbsp;&nbsp; <strong>UAE Dirham <?php echo e(\App\Helpers\NumberHelper::toWords($quote->total)); ?></strong>
    </div>
        ...
        <table class="tax-table" style="width: 100%;">
            ...
            <tbody>
                ...
                <tr style="font-weight: bold; border-top: 1px solid #eee;">
                    <td>Total</td>
                    <td>AED<?php echo e(number_format($quote->subtotal, 2)); ?></td>
                    <td>AED<?php echo e(number_format($quote->vat_amount, 2)); ?></td>
                </tr>
            </tbody>
        </table>
    </div>
...
<?php /**PATH /home/runner/work/zeronix-portal/zeronix-portal/backend/resources/views/pdf/quote.blade.php ENDPATH**/ ?>