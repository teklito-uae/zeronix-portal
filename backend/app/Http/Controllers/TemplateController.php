...
class TemplateController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'type' => 'required|string|in:quote,invoice,sales_order,payment_slip,supplier_payment_slip,purchase_bill,delivery_note',
        ...
        return response()->json([
            ...
            [
                ...
                'placeholders' => [
                    ...
                    ['key' => '{supplier_company}', 'label' => 'Supplier Company'],
                    ['key' => '{supplier_email}', 'label' => 'Supplier Email'],
                    ['key' => '{receipt_number}', 'label' => 'Receipt Number'],
                    ['key' => '{payment_date}', 'label' => 'Payment Date'],
                    ['key' => '{payment_method}', 'label' => 'Payment Method'],
                    ['key' => '{reference_id}', 'label' => 'Reference ID'],
                    ['key' => '{bill_number}', 'label' => 'Purchase Bill Number'],
                    ['key' => '{amount}', 'label' => 'Amount'],
                    ['key' => '{amount_in_words}', 'label' => 'Amount in Words'],
                    ['key' => '{notes}', 'label' => 'Notes'],
                ],
