        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="text-align: right; vertical-align: bottom;">
                    <span style="color: #666;">Invoice Date :</span> &nbsp;&nbsp;&nbsp;&nbsp; {{ date('d M Y', strtotime($invoice->date)) }}
                </td>
            </tr>
        </table>
    </div>
    ...
    <table class="item-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: right; font-weight: bold; border-bottom: 0;">{{ number_format($invoice->subtotal, 2) }}</td>
            </tr>
            <tr class="total-row">
                <td colspan="2" style="border: 0; background: white;">Items in Total {{ count($invoice->items) }}.00</td>
                <td colspan="2" style="border: 0; background: white;"></td>
                <td style="text-align: right; padding: 10px 8px;">Total</td>
                <td style="text-align: right; padding: 10px 8px;">AED{{ number_format($invoice->total, 2) }}</td>
            </tr>
        </tbody>
    </table>

    <div class="words-total">
        Total In Words: &nbsp;&nbsp; <strong>UAE Dirham {{ \App\Helpers\NumberHelper::toWords($invoice->total) }}</strong>
    </div>
        ...
        <table class="tax-table" style="width: 100%;">
            ...
            <tbody>
                ...
                <tr style="font-weight: bold; border-top: 1px solid #eee;">
                    <td>Total</td>
                    <td>AED{{ number_format($invoice->subtotal, 2) }}</td>
                    <td>AED{{ number_format($invoice->vat_amount, 2) }}</td>
                </tr>
            </tbody>
        </table>
    </div>
